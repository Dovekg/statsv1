        ...
        <div class="sidebar-category sidebar-category-visible">
            ...
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li><a href="/dashboard"><i class="icon-home4"></i> <span>管理员面板</span></a></li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="icon-users"></i> <span>用户和角色管理</span></a>
                        <ul>
                            <li><a href="/dashboard/users">所有用户</a></li>
                            <li><a href="/dashboard/roles">所有角色</a></li>
                            <li><a href="/dashboard/perms">所有权限</a></li>
                        </ul>
                    </li>
                    <li><a href="/teams"><i class="icon-make-group"></i><span>小组和邀请</span></a></li>
